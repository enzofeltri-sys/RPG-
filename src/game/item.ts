...
// (see WEAPON_SCALING_STAT) — kept as 4 distinct types rather than 2 purely
...
const TEMPLATES: ItemTemplate[] = [
  ...
  },
  {
    ...
    // had no staff/tome option before palier 2's archivist_wand, meaning
    ...
    // Staves/tomes carry two elemental lines from the start (see the
    // staff/tome comment further down for why) — a melee weapon of the
  ...
  // Rounding out palier 1 to 4 weapons of each of the 6 weapon types (12
  // total per type once all 3 paliers are combined, on the player's
  // request for an even roster) — 'tome' is an entirely new type here,
  // mechanically identical to 'staff' (both scale Intelligence, both carry
  // two elemental lines from legendary onward) but its own flavor family.
  {
    baseId: 'militia_sword',
    name: 'Épée du milicien',
    category: 'weapon',
    weaponType: 'sword',
    tier: 1,
    baseStatRolls: { strength: [1, 2, 2] },
    rareOnlyStatRolls: { fireDamage: [1, 2, 2] },
    legendaryOnlyStatRolls: { strength: [1, 1, 2] },
  },
  {
    baseId: 'lumberjack_hatchet',
    name: 'Hachette de bûcheron',
    category: 'weapon',
    weaponType: 'axe',
    tier: 1,
    baseStatRolls: { strength: [1, 2, 2] },
    rareOnlyStatRolls: { earthDamage: [1, 1, 2] },
    legendaryOnlyStatRolls: { strength: [1, 1, 2] },
  },
  {
    baseId: 'sentry_axe',
  ...
  {
    baseId: 'throwing_hatchet',
    name: 'Petite hache de jet',
    category: 'weapon',
    weaponType: 'axe',
    tier: 1,
    baseStatRolls: { strength: [1, 2, 3] },
    rareOnlyStatRolls: { earthDamage: [1, 1, 2] },
    legendaryOnlyStatRolls: { earthDamage: [1, 1, 2] },
  },
  {
    baseId: 'dull_dagger',
    name: 'Dague émoussée',
    ...
    rareOnlyStatRolls: { fireDamage: [1, 1, 2] },
    legendaryOnlyStatRolls: { agility: [1, 1, 2], lifeSteal: [1, 1, 2] },
  },
  {
    baseId: 'belt_stiletto',
    name: 'Stylet de ceinture',
    category: 'weapon',
    weaponType: 'dagger',
    tier: 1,
    baseStatRolls: { agility: [1, 2, 2] },
    rareOnlyStatRolls: { fireDamage: [1, 1, 2] },
    legendaryOnlyStatRolls: { agility: [1, 1, 2], lifeSteal: [1, 1, 2] },
  },
  {
    baseId: 'switchblade_dagger',
    name: "Dague à cran d'arrêt",
    category: 'weapon',
    weaponType: 'dagger',
    tier: 1,
    baseStatRolls: { agility: [1, 2, 3] },
  ...
  },
  {
    ...
    tier: 1,
    baseStatRolls: { agility: [1, 1, 2] },
    rareOnlyStatRolls: { poisonDamage: [1, 1, 1] },
    legendaryOnlyStatRolls: { electricDamage: [1, 1, 1] },
  },
  {
    baseId: 'reinforced_bow',
    name: 'Arc renforcé',
    category: 'weapon',
    weaponType: 'bow',
    tier: 1,
  ...
  {
    baseId: 'small_composite_bow',
    name: 'Petit arc composite',
    category: 'weapon',
    weaponType: 'bow',
    tier: 1,
    baseStatRolls: { agility: [1, 2, 3] },
    rareOnlyStatRolls: { poisonDamage: [1, 2, 2] },
    legendaryOnlyStatRolls: { electricDamage: [1, 1, 2] },
  },
  {
    baseId: 'wicker_staff',
  ...
  },
  {
    ...
    weaponType: 'staff',
    tier: 1,
    baseStatRolls: { intelligence: [1, 2, 2] },
    rareOnlyStatRolls: { fireDamage: [4, 5, 5] },
    legendaryOnlyStatRolls: { intelligence: [1, 1, 2], darkDamage: [2, 2, 3] },
  },
  {
    baseId: 'study_cane',
    name: "Canne d'étude",
    ...
    baseStatRolls: { intelligence: [1, 2, 3] },
    rareOnlyStatRolls: { fireDamage: [4, 5, 6] },
    legendaryOnlyStatRolls: { intelligence: [1, 2, 2], electricDamage: [2, 2, 3] },
  },
  {
    baseId: 'elemental_grimoire',
  ...
  {
    baseId: 'spell_manual',
    name: 'Manuel de sorts',
    category: 'weapon',
    weaponType: 'tome',
    tier: 1,
    baseStatRolls: { intelligence: [1, 2, 2] },
    rareOnlyStatRolls: { poisonDamage: [3, 4, 4] },
    legendaryOnlyStatRolls: { intelligence: [1, 1, 2], darkDamage: [2, 2, 3] },
  },
  {
    baseId: 'flame_codex',
    name: 'Codex des flammes',
    category: 'weapon',
    weaponType: 'tome',
    tier: 1,
    baseStatRolls: { intelligence: [1, 2, 3] },
  ...
  {
    baseId: 'leather_tome',
    name: 'Livre relié de cuir',
    category: 'weapon',
    weaponType: 'tome',
    tier: 1,
    baseStatRolls: { intelligence: [1, 2, 2] },
    rareOnlyStatRolls: { iceDamage: [3, 4, 4] },
    legendaryOnlyStatRolls: { intelligence: [1, 1, 2], earthDamage: [2, 2, 3] },
  },
  ...
  {
    baseId: 'patrol_sword',
    name: 'Épée de patrouille',
    category: 'weapon',
    weaponType: 'sword',
    tier: 2,
    baseStatRolls: { strength: [3, 4, 4] },
    rareOnlyStatRolls: { fireDamage: [2, 3, 3] },
    legendaryOnlyStatRolls: { strength: [2, 2, 3] },
  },
  {
    baseId: 'smuggler_blade',
    name: 'Lame de contrebandier',
    category: 'weapon',
    weaponType: 'sword',
    tier: 2,
    baseStatRolls: { strength: [3, 4, 5] },
  ...
  {
    baseId: 'sentinel_axe',
    name: 'Hache de sentinelle',
    category: 'weapon',
    weaponType: 'axe',
    tier: 2,
    baseStatRolls: { strength: [3, 4, 5] },
    rareOnlyStatRolls: { earthDamage: [2, 3, 3] },
    legendaryOnlyStatRolls: { strength: [2, 2, 3] },
  },
  {
    baseId: 'marsh_hatchet',
    name: 'Hachette des marais',
    category: 'weapon',
    weaponType: 'axe',
    tier: 2,
    baseStatRolls: { strength: [3, 4, 4] },
    rareOnlyStatRolls: { earthDamage: [2, 2, 3] },
    legendaryOnlyStatRolls: { earthDamage: [2, 2, 3] },
  },
  {
  ...
  {
    baseId: 'dock_dagger',
    name: 'Dague des quais',
    category: 'weapon',
    weaponType: 'dagger',
    tier: 2,
    baseStatRolls: { agility: [3, 4, 4] },
    rareOnlyStatRolls: { fireDamage: [2, 3, 3] },
    legendaryOnlyStatRolls: { agility: [2, 2, 3], lifeSteal: [2, 2, 3] },
  },
  {
    baseId: 'archivist_dagger',
    name: "Poignard d'archiviste",
    category: 'weapon',
    weaponType: 'dagger',
    tier: 2,
    baseStatRolls: { agility: [3, 4, 5] },
    rareOnlyStatRolls: { fireDamage: [2, 3, 4] },
    legendaryOnlyStatRolls: { agility: [2, 3, 3], lifeSteal: [2, 2, 3] },
  },
  {
    baseId: 'frost_dagger',
    name: 'Dague à froid',
    ...
    tier: 2,
    baseStatRolls: { agility: [3, 4, 4] },
    rareOnlyStatRolls: { iceDamage: [2, 3, 3] },
    legendaryOnlyStatRolls: { agility: [2, 2, 3], lifeSteal: [2, 2, 3] },
  },
  {
    baseId: 'marsh_bow',
    name: 'Arc des tourbières',
    category: 'weapon',
    weaponType: 'bow',
    tier: 2,
    baseStatRolls: { agility: [3, 4, 4] },
  ...
  {
    baseId: 'garrison_longbow',
    name: 'Arc long de garnison',
    category: 'weapon',
    weaponType: 'bow',
    tier: 2,
    baseStatRolls: { agility: [3, 4, 5] },
    rareOnlyStatRolls: { poisonDamage: [2, 3, 4] },
    legendaryOnlyStatRolls: { electricDamage: [2, 3, 3] },
  },
  {
    baseId: 'reinforced_composite_bow',
    name: 'Arc composite renforcé',
    category: 'weapon',
    weaponType: 'bow',
    tier: 2,
    baseStatRolls: { agility: [3, 4, 4] },
    rareOnlyStatRolls: { poisonDamage: [2, 2, 3] },
    legendaryOnlyStatRolls: { electricDamage: [2, 2, 3] },
  },
  {
    baseId: 'guard_staff',
    name: 'Bâton de la garde',
    category: 'weapon',
    weaponType: 'staff',
    tier: 2,
    baseStatRolls: { intelligence: [3, 4, 4] },
    rareOnlyStatRolls: { fireDamage: [5, 6, 7] },
    legendaryOnlyStatRolls: { intelligence: [2, 2, 3], iceDamage: [3, 3, 4] },
  },
  {
    baseId: 'marsh_scepter',
    name: 'Sceptre des marais',
    category: 'weapon',
    weaponType: 'staff',
    tier: 2,
    baseStatRolls: { intelligence: [3, 4, 5] },
    rareOnlyStatRolls: { poisonDamage: [4, 5, 5] },
    legendaryOnlyStatRolls: { intelligence: [2, 2, 3], darkDamage: [3, 3, 4] },
  },
  {
    baseId: 'enchanted_steel_staff',
    name: "Bâton d'acier enchanté",
    category: 'weapon',
    weaponType: 'staff',
    tier: 2,
    baseStatRolls: { intelligence: [3, 4, 4] },
    rareOnlyStatRolls: { fireDamage: [5, 6, 6] },
    legendaryOnlyStatRolls: { intelligence: [2, 3, 3], electricDamage: [3, 3, 4] },
  },
  {
    baseId: 'guard_grimoire',
    name: 'Grimoire de la garde',
    category: 'weapon',
    weaponType: 'tome',
    tier: 2,
    baseStatRolls: { intelligence: [3, 4, 4] },
  ...
  {
    baseId: 'archivist_manuscript',
    name: "Manuscrit d'archiviste",
    category: 'weapon',
    weaponType: 'tome',
    tier: 2,
    baseStatRolls: { intelligence: [3, 4, 5] },
    rareOnlyStatRolls: { fireDamage: [5, 6, 6] },
    legendaryOnlyStatRolls: { intelligence: [2, 3, 3], darkDamage: [3, 3, 4] },
  },
  ...
  {
    baseId: 'order_blade',
    name: "Lame de l'Ordre",
    category: 'weapon',
    weaponType: 'sword',
    tier: 3,
    baseStatRolls: { strength: [5, 6, 6] },
    rareOnlyStatRolls: { fireDamage: [4, 5, 6] },
    legendaryOnlyStatRolls: { strength: [3, 3, 4] },
  },
  {
    baseId: 'blackened_sword',
    name: 'Épée noircie',
    category: 'weapon',
    weaponType: 'sword',
    tier: 3,
    baseStatRolls: { strength: [5, 6, 7] },
    rareOnlyStatRolls: { darkDamage: [4, 5, 5] },
    legendaryOnlyStatRolls: { strength: [3, 4, 4] },
  },
  {
    baseId: 'watcher_axe',
    name: 'Hache du Veilleur',
    category: 'weapon',
    weaponType: 'axe',
    tier: 3,
    baseStatRolls: { strength: [5, 6, 7] },
  ...
  {
    baseId: 'shadow_hatchet',
    name: "Hachette de l'Ombre",
    category: 'weapon',
    weaponType: 'axe',
    tier: 3,
    baseStatRolls: { strength: [5, 6, 6] },
    rareOnlyStatRolls: { earthDamage: [3, 4, 4] },
    legendaryOnlyStatRolls: { earthDamage: [3, 3, 4] },
  },
  {
  ...
  {
    baseId: 'watcher_dagger',
    name: 'Dague du Veilleur',
    category: 'weapon',
    weaponType: 'dagger',
    tier: 3,
    baseStatRolls: { agility: [5, 6, 6] },
    rareOnlyStatRolls: { fireDamage: [3, 4, 5] },
    legendaryOnlyStatRolls: { agility: [3, 3, 4], lifeSteal: [3, 3, 4] },
  },
  {
    baseId: 'shadow_fang',
    name: "Croc de l'Ombre",
    category: 'weapon',
    weaponType: 'dagger',
    tier: 3,
    baseStatRolls: { agility: [5, 6, 7] },
    rareOnlyStatRolls: { poisonDamage: [4, 5, 5] },
    legendaryOnlyStatRolls: { agility: [3, 4, 4], lifeSteal: [3, 3, 4] },
  },
  {
    ...
    tier: 3,
    baseStatRolls: { agility: [5, 6, 6] },
    rareOnlyStatRolls: { darkDamage: [3, 4, 4] },
    legendaryOnlyStatRolls: { agility: [3, 3, 4], lifeSteal: [3, 3, 4] },
  },
  {
    baseId: 'seal_bow',
  ...
  },
  {
    ...
    tier: 3,
    baseStatRolls: { agility: [5, 6, 7] },
    rareOnlyStatRolls: { poisonDamage: [4, 5, 6] },
    legendaryOnlyStatRolls: { electricDamage: [3, 3, 4] },
  },
  {
    baseId: 'ritual_bow',
    name: 'Arc rituel',
    ...
    tier: 3,
    baseStatRolls: { agility: [5, 6, 6] },
    rareOnlyStatRolls: { poisonDamage: [3, 4, 5] },
    legendaryOnlyStatRolls: { electricDamage: [3, 4, 4] },
  },
  {
    baseId: 'watcher_staff',
    name: 'Bâton du Veilleur',
    category: 'weapon',
    weaponType: 'staff',
    tier: 3,
    baseStatRolls: { intelligence: [5, 6, 6] },
    rareOnlyStatRolls: { fireDamage: [7, 8, 8] },
    legendaryOnlyStatRolls: { intelligence: [3, 3, 4], iceDamage: [4, 5, 5] },
  },
  {
    baseId: 'shadow_scepter',
    name: "Sceptre de l'Ombre",
    category: 'weapon',
    weaponType: 'staff',
    tier: 3,
    baseStatRolls: { intelligence: [5, 6, 7] },
    rareOnlyStatRolls: { darkDamage: [6, 7, 7] },
    legendaryOnlyStatRolls: { intelligence: [3, 4, 4], iceDamage: [4, 5, 5] },
  },
  {
    baseId: 'mithril_staff',
    name: 'Bâton de mithril',
    category: 'weapon',
    weaponType: 'staff',
    tier: 3,
    baseStatRolls: { intelligence: [5, 6, 6] },
    rareOnlyStatRolls: { fireDamage: [7, 8, 8] },
    legendaryOnlyStatRolls: { intelligence: [3, 3, 4], electricDamage: [4, 5, 5] },
  },
  {
    baseId: 'watcher_grimoire',
    name: 'Grimoire du Veilleur',
    category: 'weapon',
    weaponType: 'tome',
    tier: 3,
    baseStatRolls: { intelligence: [5, 6, 6] },
  ...
  {
    baseId: 'shadow_codex',
    name: "Codex de l'Ombre",
    category: 'weapon',
    weaponType: 'tome',
    tier: 3,
    baseStatRolls: { intelligence: [5, 6, 7] },
    rareOnlyStatRolls: { darkDamage: [6, 7, 7] },
    legendaryOnlyStatRolls: { intelligence: [3, 4, 4], poisonDamage: [4, 5, 5] },
  },
  {
    baseId: 'mithril_codex',
    name: 'Codex de mithril',
    category: 'weapon',
    weaponType: 'tome',
    tier: 3,
    baseStatRolls: { intelligence: [5, 6, 6] },
    rareOnlyStatRolls: { earthDamage: [6, 7, 7] },
    legendaryOnlyStatRolls: { intelligence: [3, 3, 4], electricDamage: [4, 5, 5] },
  },
  {
    baseId: 'ritual_grimoire',
    name: 'Grimoire rituel',
    category: 'weapon',
    weaponType: 'tome',
    tier: 3,
    baseStatRolls: { intelligence: [5, 6, 7] },
    rareOnlyStatRolls: { darkDamage: [7, 8, 8] },
    legendaryOnlyStatRolls: { intelligence: [3, 4, 4], fireDamage: [4, 5, 5] },
  },
