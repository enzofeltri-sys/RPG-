...
export class ThirdAltarScene extends Phaser.Scene {
  ...
  private addTombs(): void {
    ...
    tomb(20, 360, 24, 60);
    tomb(WORLD_WIDTH - 20, 280, 24, 60);
    tomb(20, 140, 24, 60);
    tomb(WORLD_WIDTH - 20, 360, 24, 60);
  }
  ...
  private addBossZone(): void {
    ...
    const y = 70;
    const marker = this.add.rectangle(x, y, 50, 50, 0x0c0a0e, 0.85).setStrokeStyle(2, 0xe8d9b5);
